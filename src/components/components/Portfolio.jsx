  ...
  return (
    <div className="w-full mt-2 px-4  desktop:mt-[12rem] py-[8rem]">
      <div className="flex flex-col justify-center items-center ">
        ...
        <div className="w-full rounded-xl flex flex-col desktop:flex-row justify-evenly desktop:space-x-3 py-10 mt-8 desktop:px-[4rem]">
          <div className="desktop:w-[24rem] shadow-xl rounded-xl px-8 py-10">
